...
create table ROLE(id bigint generated by default as identity (start with 1), ROLENAME VARCHAR(100) not null, ROLECODE VARCHAR(100) not null, VALID boolean DEFAULT TRUE);
