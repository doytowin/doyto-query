...
public class SQLServerDialect implements Dialect {
    ...
    @Override
    public <I> I resolveKey(Number key, Class<I> idClass) {
        if (idClass.equals(Long.class)) {
            ...
            return idClass.cast(key.shortValue());
        }
        throw new IllegalArgumentException("Unsupported type " + idClass.getName() + " for " + key +
